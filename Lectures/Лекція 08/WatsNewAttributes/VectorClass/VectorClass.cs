...
// у цій бібліотеці використовують користувацькі атрибути для документування змін

namespace Wrox.ProCSharp.VectorClass
{
    [LastModified("15 May 2018", "Some changes", Issues = "Wake up students!")]
    [LastModified("18 May 2016", "No any changes", Issues = "Learning!")]
    ...
    // математичний вектор - елемент простору R^3
    public class Vector : IFormattable, IEnumerable
    {
        ...
        [LastModified("3 April 2019", "Constructor changed", Issues = "Set ordinate to 1")]
        [LastModified("15 May 2018", "Constructor added")]
        ...
        // дії з векторами
        [LastModified("1 April 2021", "Nothing changed", Issues = "Just a joke")]
