...
namespace MyApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            double max_population = list_countries.Max(c => c.setPopulation);
            Console.WriteLine("*Найбільш густонаселена країна*");
            foreach (Country con in list_countries)
            {
                if (con.setPopulation == max_population)
                {
            ...
            double max_vvp = list_countries.Max(c => c.populationDensity());
            Console.WriteLine("*Найбільше ВВП на одну людину*");
            foreach (Country con in list_countries)
            {
                if (con.populationDensity() == max_vvp)
                {
                    Console.WriteLine(con);
                    con.printOn();
                }
...
namespace MyApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var max_population = linkedList_countries.Max(x => x.setPopulation);
            Console.WriteLine("*Найбільш густонаселена країна*");
            foreach (Country c in linkedList_countries)
            {
                if (c.setPopulation == max_population)
                {
                    Console.WriteLine(c);
                    c.printOn();
                }
            ...
            var max_vvp = linkedList_countries.Max(x => x.populationDensity());
            Console.WriteLine("*Найбільше ВВП на одну людину*");
            foreach (Country c in linkedList_countries)
            {
                if (c.populationDensity() == max_vvp)
                {
                    Console.WriteLine(c);
                    c.printOn();
                }
...
namespace MyApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("*Впорядкові країни на назвою*\n");
            Queue<Country> orderedByName = new Queue<Country>(queue_countries.OrderBy(z => z.setName));
            Console.WriteLine(string.Join("\n\n", orderedByName));
            Console.WriteLine("\n----\n");

            Console.WriteLine("*Впорядкові країни на ВВП*\n");
            Queue<Country> orderedByVVP = new Queue<Country>(queue_countries.OrderBy(z => z.setVVP));
            Console.WriteLine(string.Join("\n\n", orderedByVVP));
            Console.WriteLine("\n----\n");

            var max_population = queue_countries.Max(x => x.setPopulation);
            Console.WriteLine("*Найбільш густонаселена країна*");
            ...
            var max_vvp = queue_countries.Max(x => x.populationDensity());
            Console.WriteLine("*Найбільше ВВП на одну людину*");
            foreach (Country c in queue_countries)
            {
                if (c.populationDensity() == max_vvp)
...
namespace MyApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var max_population = stack_countries.Max(x => x.setPopulation);
            Console.WriteLine("*Найбільш густонаселена країна*");
            ...
            var max_vvp = stack_countries.Max(x => x.populationDensity());
            Console.WriteLine("*Найбільше ВВП на одну людину*");
            foreach (Country c in stack_countries)
            {
                if (c.populationDensity() == max_vvp)
